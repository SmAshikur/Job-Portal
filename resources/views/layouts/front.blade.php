...
<head>
    ...
    <link rel="stylesheet" href="{{asset('partial/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('partial/css/magnific-popup.css')}}">
    <link rel="stylesheet" href="{{asset('partial/css/jquery-ui.css')}}">
    <link rel="stylesheet" href="{{asset('partial/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{asset('partial/css/owl.theme.default.min.css')}}">
    <link rel="stylesheet" href="{{asset('partial/css/bootstrap-datepicker.css')}}">
    <link rel="stylesheet" href="{{asset('partial/css/animate.css')}}">

    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/mediaelement@4.2.7/build/mediaelementplayer.min.css">



    <link rel="stylesheet" href="{{asset('partial/fonts/flaticon/font/flaticon.css')}}">
            ...
            <div class="row pt-5 mt-5 text-center">
                <div class="col-md-12">
                    <p>
                        ...
                        Copyright &copy; <script data-cfasync="false" src="{{asset('partial/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js')}}"></script><script>document.write(new Date().getFullYear());</script> All Rights Reserved | This template is made with <i class="icon-heart text-warning" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank" >Colorlib</a>
                        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </p>
                </div>
...
<script src="{{asset('partial/js/popper.min.js')}}"></script>
<script src="{{asset('partial/js/bootstrap.min.js')}}"></script>
<script src="{{asset('partial/js/owl.carousel.min.js')}}"></script>
<script src="{{asset('partial/js/jquery.stellar.min.js')}}"></script>
<script src="{{asset('partial/js/jquery.countdown.min.js')}}"></script>
<script src="{{asset('partial/js/jquery.magnific-popup.min.js')}}"></script>
<script src="{{asset('partial/js/bootstrap-datepicker.min.js')}}"></script>
<script src="{{asset('partial/js/aos.js')}}"></script>


<script src="{{asset('partial/js/mediaelement-and-player.min.js')}}"></script>

<script src="{{asset('partial/js/main.js')}}"></script>
